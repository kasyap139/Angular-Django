...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ui-elements-ui-elements-module"], {
    ...
    var AlertComponent = /*#__PURE__*/function () {
      ...
      function AlertComponent(_config, changeDetection) {
        ...
        this.dismissibleChange.subscribe(function (dismissible) {
          _this41.classes = _this41.dismissible ? 'alert-dismissible' : '';

          _this41.changeDetection.markForCheck();
        });
      }
      /**
       * @return {?}
      ...
      _createClass(ComponentLoader, [{
        ...
        value: function listen(listenOpts) {
          ...
          var hide = this._listenOpts.hide = function () {
            return listenOpts.hide ? listenOpts.hide() : void _this43.hide();
          };
          /** @type {?} */


          var show = this._listenOpts.show = function (registerHide) {
            listenOpts.show ? listenOpts.show(registerHide) : _this43.show(registerHide);
            registerHide();
          };
          /** @type {?} */
          ...
          var toggle = function toggle(registerHide) {
            _this43.isShown ? hide() : show(registerHide);
          };
        ...
        value: function _registerOutsideClick() {
          ...
          if (this._listenOpts.outsideClick) {
            ...
            setTimeout(function () {
              _this44._globalListener = Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_0__["registerOutsideClick"])(_this44._renderer, {
                targets: [target, _this44._elementRef.nativeElement],
                outsideClick: _this44._listenOpts.outsideClick,
                hide: function hide() {
                  return _this44._listenOpts.hide();
                }
              });
            });
          }
        ...
        value: function _subscribePositioning() {
          ...
          this._zoneSubscription = this._ngZone.onStable.subscribe(function () {
            if (!_this45._componentRef) {
              return;
            }

            _this45._posService.position({
              element: _this45._componentRef.location,
              target: _this45._elementRef,
              attachment: _this45.attachment,
              appendToBody: _this45.container === 'body'
            });
          });
        }
        /**
  ...
  function node_modulesNgxBootstrap__ivy_ngcc__DropdownFesm2015NgxBootstrapDropdownJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BsDropdownState = function BsDropdownState() {
      ...
      this.dropdownMenu = new Promise(function (resolve) {
        _this46.resolveDropdownMenu = resolve;
      });
    };
    ...
    var BsDropdownContainerComponent = /*#__PURE__*/function () {
      ...
      function BsDropdownContainerComponent(_state, cd, _renderer, _element) {
        ...
        this._subscription = _state.isOpenChange.subscribe(function (value) {
          _this47.isOpen = value;
          /** @type {?} */

          var dropdown = _this47._element.nativeElement.querySelector('.dropdown-menu');

          if (dropdown && !Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["isBs3"])()) {
            _this47._renderer.addClass(dropdown, 'show');

            if (dropdown.classList.contains('dropdown-menu-right')) {
              _this47._renderer.setStyle(dropdown, 'left', 'auto');

              _this47._renderer.setStyle(dropdown, 'right', '0');
            }

            if (_this47.direction === 'up') {
              _this47._renderer.setStyle(dropdown, 'top', 'auto');

              _this47._renderer.setStyle(dropdown, 'transform', 'translateY(-101%)');
            }
          }

          _this47.cd.markForCheck();

          _this47.cd.detectChanges();
        });
      }
      /**
       * @return {?}
      ...
      _createClass(BsDropdownDirective, [{
        ...
        value: function show() {
          ...
          if (this._showInline) {
            if (!this._inlinedMenu) {
              this._state.dropdownMenu.then(function (dropdownMenu) {
                _this49._dropdown.attachInline(dropdownMenu.viewContainer, dropdownMenu.templateRef);

                _this49._inlinedMenu = _this49._dropdown._inlineViewRef;

                _this49.addBs4Polyfills();
              }) // swallow errors
              ["catch"]();
            }
          ...
          this._state.dropdownMenu.then(function (dropdownMenu) {
            ...
            /** @type {?} */
            var _dropup = _this49.dropup || typeof _this49.dropup !== 'undefined' && _this49.dropup;

            _this49._state.direction = _dropup ? 'up' : 'down';
            /** @type {?} */

            var _placement = _this49.placement || (_dropup ? 'top left' : 'bottom left'); // show dropdown


            _this49._dropdown.attach(BsDropdownContainerComponent).to(_this49.container).position({
            ...
            _this49._state.isOpenChange.emit(true);
          }) // swallow error
          ["catch"]();
        }
        /**
    ...
    var BsDropdownToggleDirective = /*#__PURE__*/function () {
      ...
      function BsDropdownToggleDirective(_changeDetectorRef, _dropdown, _element, _renderer, _state) {
        ...
        this._subscriptions.push(this._state.isOpenChange.subscribe(function (value) {
          _this50.isOpen = value;

          if (value) {
            _this50._documentClickListener = _this50._renderer.listen('document', 'click', function (event) {
              if (_this50._state.autoClose && event.button !== 2 && !_this50._element.nativeElement.contains(event.target) && !(_this50._state.insideClick && _this50._dropdown._contains(event))) {
                _this50._state.toggleClick.emit(false);

                _this50._changeDetectorRef.detectChanges();
              }
            });
            _this50._escKeyUpListener = _this50._renderer.listen(_this50._element.nativeElement, 'keyup.esc', function () {
              if (_this50._state.autoClose) {
                _this50._state.toggleClick.emit(false);
            ...
            _this50._documentClickListener();

            _this50._escKeyUpListener();
          }
        })); // populate disabled state


        this._subscriptions.push(this._state.isDisabledChange.subscribe(function (value) {
          return _this50.isDisabled = value || null;
        }));
      }
      /**
       * @return {?}
      ...
      function PositioningService(rendererFactory, platformId) {
        ...
        if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["isPlatformBrowser"])(platformId)) {
          Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'scroll'), Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'resize'), Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(0, rxjs__WEBPACK_IMPORTED_MODULE_2__["animationFrameScheduler"]), this.update$$).subscribe(function () {
            _this51.positionElements.forEach(function (positionElement) {
              positionElements(_getHtmlElement(positionElement.target), _getHtmlElement(positionElement.element), positionElement.attachment, positionElement.appendToBody, _this51.options, rendererFactory.createRenderer(null, null));
            });
          });
        }
      }
        ...
        set: function set(customClass) {
          ...
          if (this.customClass) {
            this.customClass.split(' ').forEach(function (cssClass) {
              _this52.renderer.removeClass(_this52.elementRef.nativeElement, cssClass);
            });
          }
          ...
          if (this.customClass) {
            this.customClass.split(' ').forEach(function (cssClass) {
              _this52.renderer.addClass(_this52.elementRef.nativeElement, cssClass);
            });
          }
        }
        /**
  ...
  function srcAppUiElementsUiElementsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UiElementsComponent = /*#__PURE__*/function () {
